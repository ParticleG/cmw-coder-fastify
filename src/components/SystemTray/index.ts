...
const radioConfigs: {
  ...
  },
  {
    ...
    modelType: HuggingFaceModelType.ComwareV2,
  },
  {
    title: '百业灵犀-通用',
...
export class SystemTray {
  ...
  constructor(
    modelType: HuggingFaceModelType | LinseerModelType,
    availableModels: (HuggingFaceModelType | LinseerModelType)[],
  ) {
    ...
    this.systray = new SysTray({
      menu: {
        ...
        title: 'CMW Coder',
        tooltip: `CMW Coder V${packageJson.version}`,
        items: [
          {
            title: `CMW Coder V${packageJson.version}`,
            tooltip: '当前模型：',
            enabled: false,
          },
          SysTray.separator,
